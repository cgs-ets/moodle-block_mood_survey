 ...
 * @copyright Veronica Bermegui, Michael Vangelovski, Canberra Grammar School <michael.vangelovski@cgs.act.edu.au>
 ...
 */
function block_mood_survey_pluginfile($course, $birecordorcm, $context, $filearea, $args,
    ...
    if (!$file = $fs->get_file($context->id, 'block_mood_survey', $filearea, $itemid, $filepath, $filename)
