 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_mood_survey_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('header', 'configheader', get_string('pluginname', 'block_mood_survey'));

        $mform->addElement('text', 'config_questiontitle', get_string('questiontitle', 'block_mood_survey'));
        $mform->setType('config_questiontitle', PARAM_TEXT);

        $type = 'editor';
        $name = 'config_questionbody';
        $label = get_string('questionbody', 'block_mood_survey');
